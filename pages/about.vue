...
<template>
  <div class="about-page">
    <div class="container">
      <figure class="avatar">
        <img src="https://avatars0.githubusercontent.com/u/33594369?s=460&v=4" alt="Profile Image" />
      </figure>
      <p>My name is Alessandro D'Antoni and I am an experienced software engineer and freelance developer.</p>
      <br />
...
export default {
  head: {
    title: "Learn more about Alessandro D'Antoni | Alessandro D'Antoni"
  }
};
</script>
